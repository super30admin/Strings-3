 ...
 * We are using a helper function to break the number into billions (9 Zeroes), millions (6 Zeroes), 
 * thousands (6 Zeroes), hundreds (2 Zeroes), tens (1 Zeroes)and units. Basically each 
 * number from helper
