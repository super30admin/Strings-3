...
class IntegertoEnglishWords {
    ...
    // this function divide number into smaller part and call helper for smaller
    // number.
    ...
    public String numberToWords(int num) {
        ...
        String word = "";
        int i = 0;
        // loop till all number is processed, total digit is divided into subpart of 3
        // digit
        while (num > 0) {
    ...
    // helper function for the driver function, it convert 3 digit or lesser to
    // word.
