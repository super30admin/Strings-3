//first check is number less than 10, 20,100,1000,1000000, 1000000000.
// then take left most digit and concat string as per number length and again call recursion on remaining digit 
...
public class IntToEnglishWord {
	    ...
	    private static String helper(int num) {
	        ...
	        return result.trim(); //remove unicode characters
	    }
	    
	    public static void main(String[] args) {
	    	int in = 1234;
	    	String result = numberToWords(in);
